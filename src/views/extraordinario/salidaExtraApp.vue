              ...
              <div class="header-body">
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <!-- Title -->
                    <h1 class="header-title">Nueva salida</h1>
                  </div>
                </div>
                <!-- / .row -->
                <div class="row align-items-center">
                  <div class="col">
                    ...
                    <ul class="nav nav-tabs nav-overflow header-tabs">
                        <li class="nav-item">
                        <router-link to="/extraordinario" class="nav-link">Todos los registro</router-link>
                      </li>
...
<div class="col-md-12 mb-4">
    <h3><b>Salida extraordinario de producto</b></h3>
</div>
<small class="text-end text-muted mb-4">Nota: Selecciona el producto, color y talla que requiera el <br>  salida al igual que la razon del movimiento </small>
...
<div class="form-group">
    ...
    <!-- Input -->
    <input type="number" class="form-control mb-3" placeholder="0.00" v-model="salida.precio">
...
<div class="form-group">
    ...
    <small class="form-text text-muted">
        Ingresa la cantidad que se restara al stock
    </small>
    <!-- Input -->
    <input type="number" class="form-control mb-3" placeholder="0" v-model="salida.cantidad" >
...
<div class="col-12 col-md-6">
      <div class="form-group">
        ...
        <input type="text" v-model="salida.movimiento" class="form-control mb-3" placeholder="Razon del salida">
...
<div class="col-md-6 text-center">
  ...
  export default {
    ...
    if (this.colorSeleccionado && this.colorSeleccionado.tallas) {
      ...
      this.salida.color = this.colorSeleccionado.colores._id
    ...
    producto_selected(item){
        ...
        this.salida.producto = item.value;
    ...
    guardar_registro(){
      if(!this.salida.producto){
        this.$notify({
            title: 'ATENCIÓN',
            text: 'Selecciona el producto',
            type: 'warn'
          })
      }else if(!this.salida.color){
        this.$notify({
            title: 'ATENCIÓN',
            text: 'Selecciona el color',
            type: 'warn'
          })
      }else if(!this.salida.talla){
        this.$notify({
            title: 'ATENCIÓN',
            text: 'Selecciona la talla',
            type: 'warn'
          })
      }else if(!this.salida.precio && !this.salida.cantidad){
        this.$notify({
            title: 'ATENCIÓN',
            text: 'Ingresa el nuevo precio o la cantidad a restar ',
            type: 'warn'
          })
      }else if(!this.salida.movimiento){
        this.$notify({
            title: 'ATENCIÓN',
        ...
        axios.post(this.$url+'/salida_extraordinaria/'+this.salida.producto,this.salida,{
          headers:{
            'Content-Type': 'application/json',
            'Authorization': this.$store.state.token
          }
